...
import Card from "./card"; // Assuming the correct path for the Card component
        ...
        <AnimatePresence>
          {isModalOpen && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="fixed top-0 left-0 w-full h-full  bg-opacity-70 flex items-center justify-center"
            >
              <div className="bg-white p-6 rounded-[40px]">
                <div className="relative float-label-input">
                  <input
                    ...
                    type="text"
                    placeholder=" "
                    className="block bg-white w-[350px] focus:outline-none focus:shadow-outline border border-black-500 rounded-md py-3 px-3 appearance-none leading-normal"
                  />
                  <label htmlFor="fileTitle" className="absolute top-3 left-0 text-black-500 pointer-events-none transition duration-200 ease-in-outbg-white px-2">
                    Description
                  </label>
                </div>
                <label
